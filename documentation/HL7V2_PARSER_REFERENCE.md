...
The parser is divided into two parts:
  ...
  1. Low-level functions that implement a tokenizer, lexer, parser, and callback (SAX-like) parser for the [HL7](http://www.hl7.org/) protocol.
...
The HL7 parser has no runtime dependency other than the standard C library, but it requires [qmake](http://qt-project.org/wiki/Category:Tools::qmake) from the [Qt project](http://www.qt-project.org/) to generate its makefiles.
